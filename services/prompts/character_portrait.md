...
- Do not use outside franchise knowledge or famous cast lists. Only name people supported by these exact page images, chapter context, or known/project hints.
...
- Do not output generic phrases, dialogue fragments, placeholder literals, or OCR junk as names. Forbidden names include "name", "null", "None", color-only labels, and unrelated franchise names.
